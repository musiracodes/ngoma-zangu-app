package ke.co.musira.musicplayergo;
...
import ke.co.musira.musicplayergo.R;

import ke.co.musira.musicplayergo.adapters.AlbumsAdapter;
import ke.co.musira.musicplayergo.adapters.ArtistsAdapter;
import ke.co.musira.musicplayergo.adapters.ColorsAdapter;
import ke.co.musira.musicplayergo.adapters.SongsAdapter;
import ke.co.musira.musicplayergo.loaders.ArtistProvider;
import ke.co.musira.musicplayergo.models.Album;
import ke.co.musira.musicplayergo.models.Artist;
import ke.co.musira.musicplayergo.models.Song;
import ke.co.musira.musicplayergo.playback.EqualizerUtils;
import ke.co.musira.musicplayergo.playback.MusicNotificationManager;
import ke.co.musira.musicplayergo.playback.MusicService;
import ke.co.musira.musicplayergo.playback.PlaybackInfoListener;
import ke.co.musira.musicplayergo.playback.PlayerAdapter;
import ke.co.musira.musicplayergo.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://musira.co.ke")));
